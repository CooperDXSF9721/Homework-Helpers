      ...
      <div>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
            placeholder="Paste image URL from Google Drive, ImgBB, etc."
          />
          <p className="text-xs text-gray-500 mt-1">
            Upload image to Google Drive, get shareable link, and paste here
          </p>
          {newPost.imageUrl && (
            <div className="mt-2">
              <img src={newPost.imageUrl} alt="Preview" className="w-32 h-32 object-cover rounded" />
              <p className="text-xs text-green-600 mt-1">✓ Image URL added</p>
            </div>
          )}
        </div>
        <div className="mb-4">
